...
public final class APrintSimpleStatement extends PStatement
{
    ...
    public Object clone()
    {
        return new APrintSimpleStatement(
    ...
    {
        ((Analysis) sw).caseAPrintSimpleStatement(this);
    }
    ...
    private class CommaExpression_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != APrintSimpleStatement.this))
            {
                node.parent().removeChild(node);
            }
